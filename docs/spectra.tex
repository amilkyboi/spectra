...
From \textit{Molecular Spectroscopic Constants of O$_2$ (B$\state{3}{\Sigma}^-_u$): The Upper State of the Schumann--Runge Bands} by Cheung, Eq. (3):
\begin{equation*}
    T(v') = T_0 + \omega_e\ab(v' + \tfrac{1}{2}) - \omega_ex_e\ab(v' + \tfrac{1}{2})^2 + \omega_ey_e\ab(v' + \tfrac{1}{2})^3 + \omega_ez_e\ab(v' + \tfrac{1}{2})^4 + \omega_ea_e\ab(v' + \tfrac{1}{2})^5
\end{equation*}

Same source, Eq. (4):
\begin{equation*}
    B(v') = B_e - \alpha_e\ab(v' + \tfrac{1}{2}) + \gamma_e\ab(v' + \tfrac{1}{2})^2 + \delta_e\ab(v' + \tfrac{1}{2})^3
\end{equation*}
...
\end{equation*}
\begin{equation*}
    T + Bx - Dx^2 + \tfrac{2}{3}\lambda - \gamma + \tfrac{2}{3}x\lambda_D - x\gamma_D
\end{equation*}
\begin{equation*}
    \bmx{T + B(x + 2) - D(x^2 + 8x + 4) - \tfrac{4}{3}\lambda - 2\gamma - \tfrac{4}{3}\lambda_D(x + 2) - 4\gamma_D(x + 1) & -2\sqrt{x}\ab[B - 2D(x + 1) - \tfrac{\gamma}{2} - \tfrac{2}{3}\lambda_D - \tfrac{1}{2}\gamma_D(x + 4)] \\
        \text{sym.} & T + Bx - D(x^2 + 4x) + \tfrac{2}{3}\lambda - \gamma + \tfrac{2}{3}x\lambda_D - 3x\gamma_D}
\end{equation*}
