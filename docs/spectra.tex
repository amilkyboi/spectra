...
The Hamiltonian is, Cheung Eq. (1):
\begin{equation*}
...
\begin{align*}
    \sop{H} & = B\pmx{J(J - 1)                                 & 0                                & 0 \\ 0 & (J + 1)(J + 2) & 0 \\ 0 & 0 & J(J + 1)} \\
            & + \lambda\pmx{\tfrac{-2J}{2J + 1} + \tfrac{2}{3} & \tfrac{2\sqrt{J(J + 1)}}{2J + 1} & 0 \\ \tfrac{2\sqrt{J(J + 1)}}{2J + 1} & \tfrac{-2(J + 1)}{2J + 1} + \tfrac{2}{3} & 0 \\ 0 & 0 & \tfrac{2}{3}} \\
