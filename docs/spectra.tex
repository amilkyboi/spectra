...
\usepackage{amssymb, booktabs, derivative, fancyhdr, float, graphicx, mhchem, natex, pagecolor, pgfplots, siunitx, tikz}
...
Furthermore, for $N = 0$ in $B\state{3}{\Sigma}_{u}^{-}(v')$, only the $F_1$ level exists.
...
From \textit{Molecular Spectroscopic Constants of \ce{O2} ($B\state{3}{\Sigma}^{-}_{u}$): The Upper State of the Schumann--Runge Bands} by Cheung, Eq. (1):
\begin{equation*}
